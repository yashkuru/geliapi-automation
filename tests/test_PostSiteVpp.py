...
class TestGeliPostVpp:
    # Test POST request for adding a site to a VPP with valid input values.
    ...
    # Test POST request for adding a site to a VPP with invalid VPP id
    ...
    # Test POST request for adding a site to a VPP with invalid site id.
    ...
    # Test POST request for adding a site to a VPP with invalid payload
    ...
    # Test POST request for adding a site to a VPP with duplicate site id
    @pytest.mark.parametrize("site_id, vpp_id", [(22, 33)])
